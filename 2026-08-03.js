const DailyConfig = {
  ...
  badge1: "☕ 피서 카페 출근",
  badge2: "🎁 치팅밀 지급일",
  alert1HTML: "<strong>☀️ 폭염 대비 카페 출근 (이번 주 한정)</strong><br>무더위로 인해 당분간 30분 거리 도서관 대신 20분 거리 카페로 피서 겸 출근합니다. 오픈 시간이 이른 카페의 특성을 살려, 9시를 기다리지 않고 아침 준비가 끝나는 대로 즉시 출발하여 하루를 조금 더 일찍, 여유롭게 시작하도록 세팅했습니다.",
  alert2HTML: "<strong>🎁 치팅밀 지급 및 쿨타임 해제</strong><br>월요일을 맞아 치팅밀 +450kcal가 정상 지급되었으며 쿨타임이 해제되었습니다. 폭염으로 입맛이 없거나 스트레스가 쌓일 때 적절히 활용해 보세요.",
  footerQuote: "유연하게 환경을 바꾸는 것도 지속적인 몰입을 위한 훌륭한 전략이다.</div><div style=\"font-size:11px;opacity:.65;margin-top:5px\">시원한 카페에서 쾌적하게 8월의 첫 주를 시작하세요!",
