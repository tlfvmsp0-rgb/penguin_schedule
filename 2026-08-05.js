const DailyConfig = {
  dateLabel: "2026.08.05 수요일 [⚖️ 보유: 0kcal | ⏳ 쿨타임 ~8/6 금지]",
  badge1: "☕ 피서 카페 출근",
  badge2: "🔥 정상 템포",
  ...
  alert2HTML: "<strong>🩸 생리 스팟팅 접근 (8/7 예정)</strong><br>생리 예정일이 다가오고 있습니다. 아직은 정상 템포(14뽀모도로)를 유지하되, 몸에 이상이 느껴지거나 통증이 시작되면 무리하지 말고 언제든 템포 조절을 지시해 주세요.",
  footerQuote: "결과를 만드는 것은 특별한 하루가 아니라, 평범함을 유지하는 수많은 하루다.</div><div style=\"font-size:11px;opacity:.65;margin-top:5px\">오늘 하루도 시원하고 쾌적하게 몰입하는 하루 되세요!",
  storageKey: "penguin_chk_20260805",
  prevStampPoints: 0 
};
