const DailyConfig = {
  dateLabel: "2026.08.06 목요일 [⚖️ 보유: 0kcal | ⏳ 쿨타임 ~8/6 금지]",
  badge1: "☕ 피서 카페 출근",
  badge2: "🩸 스팟팅 예정 근접",
  alert1HTML: "<strong>☀️ 폭염 대비 카페 출근 (이번 주 한정)</strong><br>무더위로 인해 당분간 30분 거리 도서관 대신 20분 거리 카페로 피서 겸 출근합니다. 오픈 시간이 이른 카페의 특성을 살려, 9시를 기다리지 않고 아침 준비가 끝나는 대로 즉시 출발하여 하루를 일찍 시작합니다.",
  alert2HTML: "<strong>🩸 생리 스팟팅 예정일 오차 진입</strong><br>오늘부터 생리 스팟팅 예정일(8/7 ±1일) 오차 범위에 들어옵니다. 정상 템포를 유지하되, 컨디션 저하나 통증이 발생할 경우 무리하지 말고 언제든 일정(뽀모도로) 완화를 지시해 주세요.",
  footerQuote: "나의 몸과 마음의 소리에 귀 기울이는 것이 진정한 자기 관리의 시작이다.</div><div style=\"font-size:11px;opacity:.65;margin-top:5px\">오늘 하루도 쾌적하고 편안하게 몰입하는 하루 되세요!",
  storageKey: "penguin_chk_20260806",
  prevStampPoints: 0 
};
