const DailyConfig = {
  dateLabel: "2026.08.08 토요일 [⚖️ 보유: 0kcal | ⏳ 쿨타임 해제 (8/10 지급 예정)]",
  badge1: "☕ 피서 카페 출근",
  badge2: "🩸 생리 4일차",
  alert1HTML: "<strong>☀️ 폭염 대비 카페 출근 (주말까지 유지)</strong><br>무더위로 인해 30분 거리 도서관 대신 20분 거리 카페로 피서 겸 출근합니다. 다음 주 월요일(8/10) 날씨 상황을 보고 도서관 복귀 여부를 다시 결정할 예정입니다.",
  alert2HTML: "<strong>🩸 생리 4일차: 체온 및 컨디션 관리</strong><br>생리 4일차입니다. 장시간 에어컨 바람에 노출될 수 있으니 가벼운 겉옷을 챙기고, 무리가 올 경우 언제든 뽀모도로(공부량) 완화를 지시해 주세요.",
  footerQuote: "유연하게 환경에 적응하며 묵묵히 내 할 일을 해내는 것이 진정한 프로다.</div><div style=\"font-size:11px;opacity:.65;margin-top:5px\">오늘도 시원한 곳에서 평온하고 깊게 몰입해 보세요!",
  storageKey: "penguin_chk_20260808",
  prevStampPoints: 0 
};
...
const S = [
  ...
  {id:'exNight', time:'21:45', dur:'20분', health:true, cat:'health',
   title:'🧘 취침 전 릴랙스 + 복식호흡',
   items:[
  ...
  {id:'nt', sec:'', time:'', dur:'', cat:'notes',
   title:'📌 유연한 일정을 위한 원칙',
   items:[
     '【치팅밀 룰】 [⚖️ 보유: 0kcal | ⏳ 쿨타임 해제 (8/10 지급 예정)]',
     '【다음 주 일정 점검】 다음 주 월요일(8/10)에 폭염 등 날씨 상황을 보고 도서관 복귀 여부를 다시 결정합니다.',
