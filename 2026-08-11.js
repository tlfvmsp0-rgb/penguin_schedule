const DailyConfig = {
  dateLabel: "2026.08.10 월요일 [⚖️ 보유: 450kcal | ⏳ 쿨타임 해제 (사용 가능)]",
  badge1: "☕ 피서 카페 출근",
  badge2: "🩸 생리 6일차 (마지막)",
  ...
  alert2HTML: "<strong>🎁 주간 치팅밀 지급 및 쿨타임 해제</strong><br>월요일 정기 치팅밀 +450kcal가 지급되었으며 지난번 가불로 인한 쿨타임도 완전히 해제되었습니다. 이번 주 한정으로 편하게 활용해 보세요.",
  footerQuote: "새로운 한 주의 시작은 가벼운 몸과 시원한 몰입에서 비롯된다.</div><div style=\"font-size:11px;opacity:.65;margin-top:5px\">월요일 아침, 상쾌하게 출발해 보세요!",
  storageKey: "penguin_chk_20260810",
  prevStampPoints: 0 
};
...
const Preview = [
  {d:'8/10 (월)', today:true, t:'🩸 생리 마지막 날 & ☕ 카페 출근'},
