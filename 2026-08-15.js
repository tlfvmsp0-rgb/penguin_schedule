const DailyConfig = {
  dateLabel: "2026.08.15 토요일 [⚖️ 보유: 450kcal | ⏳ 쿨타임 해제 (사용 가능)]",
  badge1: "🇰🇷 광복절",
  badge2: "☕ 카페 출근",
  alert1HTML: "<strong>🇰🇷 광복절 공휴일 (카페 출근)</strong><br>오늘은 광복절 공휴일로 본진 도서관이 휴관합니다. 무더위도 피할 겸 오픈 시간이 이른 동네 카페(도보 20분)로 어제와 같이 출근하여 정상 템포를 소화합니다.",
  alert2HTML: "<strong>🏃 완벽한 수면 리듬 복구</strong><br>어제의 강행군(특강, CBT, 치과)을 무사히 마치신 것을 축하합니다! 오늘부터는 다시 원래의 수면 리듬(06:30 기상 / 22:30 취침)으로 푹 쉬고 안정적으로 몰입할 수 있습니다.",
  footerQuote: "단단한 일상은 어떠한 변수 속에서도 나를 지켜내는 가장 튼튼한 방패다.</div><div style=\"font-size:11px;opacity:.65;margin-top:5px\">어제의 고단함을 이겨낸 펭귄 학생, 편안한 공휴일 보내세요!",
  storageKey: "penguin_chk_20260815",
  prevStampPoints: 0 
};
...
const S = [
  ...
  {id:'denAm', time:'07:50', dur:'10분', cat:'dental',
   title:'🦷 아침 양치',
   items:[
     '일반 양치 (10분) — 교정장치 구석구석 닦기 (통증 시 살살 진행)',
   ]},
  ...
  {id:'lunch', sec:'🍽️ 점심 식사 및 파워냅 (12:40~14:45)', time:'12:40', dur:'40분', cat:'meal',
   ...
   items:[
     ...
     '아침 식사 종료(07:45) 후 약 5시간 경과. 치과 진료 다음날이므로 씹기 편한 음식 위주 섭취',
   ]},
  ...
  {id:'medPm', time:'18:30', dur:'5분', cat:'meds',
   ...
   items:[
     ...
     '【선택】 닥터베스트 마그네슘 1정 추가 복용 (어제 치과 진료 및 외부 일정 피로가 덜 풀렸을 경우 권장)',
  ...
  {id:'exNight', time:'21:45', dur:'15분', cat:'health',
   title:'🧘 취침 전 릴랙스 + 복식호흡',
   items:[
  ...
  {id:'magBed', time:'22:00', dur:'5분', cat:'meds',
   title:'💊 취침 마그네슘 복용',
   items:[
     '닥터베스트 마그네슘 2정 (200mg) 복용',
     '아미노산 킬레이트가 뇌를 진정시키고 숙면을 유도합니다.',
   ]},
...
const Preview = [
  {d:'8/15 (토)', today:true, t:'🇰🇷 광복절 (도서관 휴관 / 카페 출근)'},
  {d:'8/17 (월)', t:'🇰🇷 광복절 대체공휴일 (도서관 휴관)'},
  {d:'8/18 (화)', t:'💻 취업컨설팅 Zoom 1회기 (10:00~11:00) ⚠️질문 리스트 필수!'},
